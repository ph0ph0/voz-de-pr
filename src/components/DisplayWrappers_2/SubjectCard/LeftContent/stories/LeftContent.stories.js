...
storiesOf("DisplayWrappers|SubjectCard/LeftContent", module)
  .add("Standard", () => 
    <LeftContent 
      ...
      timePassed = {"1 hour"}
    />, {
    notes: "*PROPS; profileName: string is users profile name, timeAgo: string is time since posted, title: string title of subject, subjectSummary: string is content of subject, numberOfComments: string*"
  });